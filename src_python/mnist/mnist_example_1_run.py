...
PATH_TO_MNIST_DATA = '/home/brian/data/prototyping/deep_learning_prototyping/'
###############################################################
...
def load_mnist():
    ...
    train_images = mnist_utils.load_images_3d(PATH_TO_MNIST_DATA + 'train-images-idx3-ubyte') 
    train_labels = mnist_utils.load_labels(PATH_TO_MNIST_DATA + 'train-labels-idx1-ubyte')
    test_images = mnist_utils.load_images_3d(PATH_TO_MNIST_DATA + 't10k-images-idx3-ubyte') 
    test_labels = mnist_utils.load_labels(PATH_TO_MNIST_DATA + 't10k-labels-idx1-ubyte')
...
def run_mnist_test1():
    ...
    print 'Row pixels of each image = ', training_images.shape[1]
    print 'Column pixels of each image = ', training_images.shape[2]
    DEBUG = False
    if DEBUG:
        # Plot 1 image to check the format:
        image_ind = 2
        the_image = training_images[image_ind, :, :] # One of the images, which is a 2D array.
