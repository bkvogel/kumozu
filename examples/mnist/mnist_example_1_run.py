...
def run_mnist_test1():
    ...
    print('Shape is {}'.format(training_images.shape))
    print('Number of traiing images = {}'.format(training_images.shape[0]))
    print('Row pixels of each image = {}'.format(training_images.shape[2]))
    print('Column pixels of each image = {}'.format(training_images.shape[3]))
    ...
    #runExe = '../../build-src_cpp-Desktop_Qt_5_7_1_GCC_64bit-Release/main ' + RUN_CPP_FUNCTION_NAME
    print(runExe)
    os.system(runExe)
